...
func TestFlags(t *testing.T) {
	{
		...
		t.Run("Given N := []int{1, 2, 3, 4, 3, 2, 1, 3, 5, 4, 1}, the function should return 2", func(t *testing.T) {
		...
		t.Run("Given N := []int{1, 2, 1, 2, 1, 2, 1, 2, 1, 2}, the function should return 2", func(t *testing.T) {
